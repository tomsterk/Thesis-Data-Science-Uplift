...
### This code repository contains all the SQL queries, datasets descriptions and notebooks that were used to benchmark the binary uplift RF models versus the MTUM.
---
...
│   ├── Performance experimental phase 2.sql                              # Evaluation dataset phase 2 first month
│   ├── Performance experimental pahse 2 lasting profitability.sql        # Evaluation dataset phase 2 lasting three-month profitability 
|
├── Data/
...
│   ├── df_preds.csv                                                      # Predidictions MTUM for all four different configurations of models phase 1 (not uploaded due to size)
│   ├── performance_experimental_phase_21_2026-03-13.csv                  # Customer-level results Phase 1
│   ├── Output_phase_2/performance_experimental_phase_2_2026-04-17.csv    # Customer-level results Phase 2 first month
│   └── Output_phase_2/performance_experimental_phase_2_2026-06-16.csv    # Customer-level results Phase 2 lasting three-month profitability 
├── Input_phase_2/
...
│   ├── phase2_significance_results_2026-04-17.xlsx                       # Significance tests Phase 2 first month 
│   ├── phase2_significance_results_2026-06-17.xlsx                       # Significance tests Phase 2 lasting three-month profitability 
...
│   ├── cate_explorer_v2.html                                             # Interactive CATE exploration used to share insight with CRM team and make CATE plots
│   ├── Output_qini_curves/                                               # Qini plots binary uplift models
│   └── classification_output/                                            # Precision, recall and logloss per model
│
└── Notebooks (see below)
```
